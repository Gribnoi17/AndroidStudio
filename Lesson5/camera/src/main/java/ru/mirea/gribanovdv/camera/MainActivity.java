package ru.mirea.gribanovdv.camera;
...
import ru.mirea.gribanovdv.camera.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.d(MainActivity.class.getSimpleName(), "is OnClick: " + isWork);
                if (isWork) {
                    try {
