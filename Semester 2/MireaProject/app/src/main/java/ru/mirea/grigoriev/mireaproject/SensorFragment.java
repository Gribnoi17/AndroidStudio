...
import ru.mirea.grigoriev.mireaproject.databinding.FragmentSensorBinding;
...
public class SensorFragment extends Fragment implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
       ...
       binding.textViewHeader.setText("Отклонение от севера: " + Float.toString(degree) + " градусов");
       RotateAnimation ra = new RotateAnimation(current_degree, -degree, Animation.RELATIVE_TO_SELF, 0.5f,
               Animation.RELATIVE_TO_SELF, 0.5f);
       ra.setDuration(210);

       ra.setFillAfter(true);
       binding.dynamicCompassImg.startAnimation(ra);
