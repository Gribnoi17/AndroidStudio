...
import ru.mirea.gribanovdv.yandexdriver.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity implements DrivingSession.DrivingRouteListener {

    private static final int REQUEST_CODE_PERMISSION = 100;
    private ActivityMainBinding binding;
    private final Point ROUTE_START_LOCATION = new Point(55.637073, 37.353144);
    private final Point ROUTE_END_LOCATION =  new Point(55.836100, 37.971131);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker.addTapListener(new MapObjectTapListener() {
            ...
            public boolean onMapObjectTap(@NonNull MapObject mapObject, @NonNull Point
                    point) {
                Toast.makeText(getApplication(),"Автосервис \n" + "Здвесь работает человек, который знает свое дело. \n"
                                + "Чинился у него нескольк раз, советую!",
